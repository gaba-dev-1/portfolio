...
export function Header() {
  ...
  const navbarBgStyle = isScrolled
    ? "bg-background shadow-md border-b border-accent/10"
      ...
      <div className="container-custom">
        <nav className="flex items-center justify-between">
          ...
          >
            <Link 
              href="#home" 
              className="text-2xl font-display font-bold bg-gradient-to-r from-accent to-accent/70 bg-clip-text text-transparent hover:opacity-90 transition-all"
            >
              {person.alias}
            </Link>
          </motion.div>
              ...
              {navItems.map((item, i) => (
                ...
                >
                  ...
                  >
                    ...
                    {activeSection === item.section && (
                      <motion.span 
                        className="absolute inset-0 bg-accent/5 rounded-md -z-0"
                        layoutId="navBackground"
                        transition={{ type: "spring", duration: 0.6 }}
                      />
                    )}
                    
                    <span className="absolute bottom-0 left-0 right-0 h-[3px] flex justify-center">
                      {activeSection === item.section && (
                        <motion.span 
                          className="w-1/2 bg-accent rounded-full"
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            ...
            >
              <div className="py-3 px-2 rounded-lg bg-background/95 backdrop-blur-md border border-accent/10 shadow-lg">
