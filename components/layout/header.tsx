...
export function Header() {
  ...
  useEffect(() => {
    ...
    // Initial check to set active section without waiting for scroll
    handleScroll()
  ...
  }, []) // Empty dependency array since we don't need to re-create the effect
              ...
              {navItems.map((item, i) => (
                ...
                >
                  ...
                  >
                    ...
                    {/* Dot indicator - Faster animation */}
